...
namespace APIVerve
{
    public class SEOScraperAPIClient
    {
        ...
        public SEOScraperAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public SEOScraperAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, seoscraperQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(seoscraperQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(seoscraperQueryOptions options)
        {
